    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Admin'), (2, 'Hospital'), (3, 'Patient'), (4, 'Lab'), (5, 'Pharmacy')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('registration_number', models.DateField(blank=True, default='', null=True)),
                ...
                ('establishment_year', models.DateField(default='')),
                ('website', models.URLField(blank=True, default='', max_length=256, null=True)),
                ('linkdin', models.URLField(blank=True, default='', max_length=256, null=True)),
