    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('desc', models.TextField(default='', max_length=5000, null=True)),
                ...
                ('specialist', models.CharField(blank=True, max_length=256, null=True)),
                ('profile_pic', models.FileField(default='', max_length=500, null=True, upload_to='hospital/profile')),
                ('about', models.TextField(blank=True, null=True)),
                ('is_appiled', models.BooleanField(blank=True, default=False, null=True)),
                ('is_verified', models.BooleanField(blank=True, default=False, null=True)),
                ('registration_proof', models.FileField(blank=True, max_length=500, null=True, upload_to='hospital/documents')),
                ('establishment_year', models.DateField()),
                ('website', models.URLField(blank=True, max_length=256, null=True)),
                ('linkdin', models.URLField(blank=True, max_length=256, null=True)),
