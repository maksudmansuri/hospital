...
class HospitalStaffDoctorSchedual(models.Model):
    ...
    DAYS_CHOICE                 =(("Monday","Monday"),("Tuesday","Tuesday"),("Wednessday","Wednessday"),("Thursday","Thursday"),("Friday","Friday"),("Saturday","Saturday"),("Sunday","Sunday"))
    days                        =models.CharField(choices=DAYS_CHOICE, max_length=50,default="",blank=True,null=True)
