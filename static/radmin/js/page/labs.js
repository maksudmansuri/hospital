...
$(function() {
    ...
    "use strict"; 
    var option = {};
    var whaterleval = getChart("whaterleval"); 
    ...
    if (option && typeof option === "object") {
        whaterleval.setOption(option, true);
    }  
    ...
    new ApexCharts(document.querySelector("#apexspark-chart5"), options5).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart6"), options6).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart7"), options7).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart8"), options8).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart9"), options9).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart10"), options10).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart11"), options11).render();
    ...
    new ApexCharts(document.querySelector("#apexspark-chart12"), options12).render(); 
